...
//    }
    ...
    public int dateDifference(String dateRented, String dateReturned) {
        int yyyy, mm, dd;
    ...
    public int numberOfDaysOverdue(String dateRentedx,String dateReturnedx)
    {
        int days = dateDifference(dateRentedx, dateReturnedx)-2;
        if (days < 0)
            return 0;
        else
            return days;
